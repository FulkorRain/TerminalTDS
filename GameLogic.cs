    ...
    internal class GameLogic
    {
        ...
        public void InitActionValue()
        {
            ...
            foreach (var unit in units)
            {
                ...
                Logger.Log("ActionValue Added", "GameLogic-InitActionValue", unit.Name, $"ActionValue: {ActionValue} -> {unit.ActionValue}");
                Logger.Log("LeftOverTurn Added", "GameLogic-InitActionValue", unit.Name, $"LeftOverTurn: {LeftOverTurn} -> {unit.LeftOverTurn}");
                ...
                if (unit.LeftOverTurn >= 1)
                {
                    ...
                    Logger.Log("Bonus ActionValue Added", "GameLogic-InitActionValue", unit.Name, $"ActionValue: {unit.ActionValue - BonusTurns} -> {unit.ActionValue}");
                    Logger.Log("Bonus LeftOverTurn Added", "GameLogic-InitActionValue", unit.Name, $"LeftOverTurn: {unit.LeftOverTurn + BonusTurns} -> {unit.LeftOverTurn}");
                }
            }
        }
